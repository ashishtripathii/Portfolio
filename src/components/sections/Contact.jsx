...
export const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    const SERVICE_ID = 'service_3jfpvpl';
    const TEMPLATE_ID = 'template_qrki56k';
    const PUBLIC_KEY = 'Th5Ch9VHXnAW-Ms7W';
  ...
  return <section id='contacts' className='min-h-screen  flex items-center justify-center py-20'>
    <RevealOnScroll>
      <div className='px-4 w-150'>
        ...
        <form className='space-y-6' action="" onSubmit={handleSubmit}>
          ...
          <div className='relative'>
            <textarea name="message" id="message" value={formData.message} required rows={5}
              className='w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-white transition focus:outline-none focus:border-blue-500 focus:bg-blue-500/5'
